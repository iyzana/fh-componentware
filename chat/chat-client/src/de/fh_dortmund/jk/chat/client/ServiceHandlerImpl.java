...
public class ServiceHandlerImpl extends ServiceHandler implements UserSessionHandler, ChatMessageHandler {
	...
	public ServiceHandlerImpl() {
		try {
			...
			chat = (Topic) ctx.lookup("java:global/jms/ChatOutgoing");
